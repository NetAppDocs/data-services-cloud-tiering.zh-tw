...
https://www.netapp.com/data-services/tiering/tco-calculator/["使用雲端分層 TCO 計算器來查看您可以節省多少錢"^]。
...
Cloud Tiering 授權也可以與將資料分層到 IBM Cloud Object Storage 的叢集共用。必須使用 System Manager 或ONTAP CLI 設定FabricPool配置，但link:task-licensing-cloud-tiering.html#apply-cloud-tiering-licenses-to-clusters-in-special-configurations["此類配置的授權是使用 Cloud Tiering 完成的。"]
...
link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-paygo-subscription["了解如何設定即用即付訂閱"]。
...
購買 Cloud Tiering 授權後，您需要將該授權新增至NetApp Console。link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-byol-license["了解如何使用 Cloud Tiering BYOL 許可證"]。

如上所述，即使您已經購買了 BYOL 許可證，我們也建議您設定即用即付訂閱。


NOTE: 從 2021 年 8 月開始，舊的 * FabricPool* 許可證被 * Cloud Tiering * 許可證取代。link:task-licensing-cloud-tiering.html#cloud-tiering-byol-licensing-starting-in-2021["詳細了解 Cloud Tiering 授權與FabricPool授權的區別"]。
