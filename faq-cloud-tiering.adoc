...
要獲得估算，請將您的ONTAP叢集新增至NetApp Console並透過 Cloud Tiering Clusters 頁面進行檢查。選擇叢集的「計算潛在的分層節省」以啟動 https://www.netapp.com/data-services/tiering/tco-calculator["雲端分層 TCO 計算器"^]看看您能省多少錢。
...
* link:task-tiering-onprem-aws.html#preparing-your-ontap-clusters["將資料分層到 Amazon S3"]
