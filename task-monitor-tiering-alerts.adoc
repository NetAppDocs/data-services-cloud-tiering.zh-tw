...
此通知是提高系統效率、降低儲存成本的「建議」。它表示集群分層的冷數據少於 20% - 包括沒有分層數據的集群。它提供了一個鏈接 https://www.netapp.com/data-services/tiering/tco-calculator/["Cloud Tiering 總擁有成本和節省計算器"^]幫助您計算成本節省。
